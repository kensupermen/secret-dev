  ...
  module ExceptionHandlers
    ...
    def handle_record_not_found!(e)
      errors = [
        ...
        value: e.primary_key ? e.send(e.primary_key) : ''
      ]
      error!(
    ...
    def handle_invalid_foreign_key!(_)
      error!(
        { errors: { message: I18n.t('activerecord.foreign_key_not_found') }, status_code: 404 },
        404
      )
    end
    ...
    def handle_method_not_allowed!(_)
      error!(
        { errors: { message: I18n.t('activerecord.method_not_allowed') }, status_code: 405 },
        405
      )
    end
  end
